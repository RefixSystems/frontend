        ...
        <Row className="shaded rounded d-flex flex-column  justify-content-center align-items-center text-center">
          <Col>
            <h1 className="text-bold fs-150">
              4<span className="main">0</span>4
            </h1>
          </Col>
          <Col>
          ...
          <Col className="d-flex flex-column  justify-content-center align-items-center text-center">
            <Link className="textDecoration-none" to={'/'} style={{textDecoration:"none"}}>
              <BasicButton
                label={'GO TO HOMEPAGE'}
                icon={<FaHome size={20} className="mx-2" />}
                className={
                  'bg-main d-flex align-items-center textDecoration-none border-none outline-none text-bold fs-6 fw-400'
                }
              />
            </Link>
          </Col>
