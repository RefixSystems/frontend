...
import { FaCircle, FaMinus, FaPlus, FaStar } from 'react-icons/fa';
...
const Rent = () => {
  ...
  const { data: RentFaqData } = useGetFaqParticularQuery({
    page: currentFaqPage,
    type: 'rental',
  });
  ...
  useEffect(() => {
    ...
    if (RentData && RentData.rentalBanner) {
      setBannerImage(
        Array.isArray(RentData.rentalBanner)
          ? RentData.rentalBanner
          : [RentData.rentalBanner]
      );
    }
  ...
  useEffect(() => {
    if (RentFaqData && RentFaqData.data) {
      setFaqData(RentFaqData.data);
    }
    if (RentFaqData && RentFaqData.pagination) {
      setTotalFaqPage(RentFaqData.pagination.totalPages);
      setItemsPerFaqPage(RentFaqData.pagination.itemsPerPage);
      setTotalItemsFaq(RentFaqData.pagination.totalItems);
    }
  }, [RentFaqData, currentFaqPage]);
  ...
  const navigateToRentDetails = (laptop) => {
    navigate('/rent/rent-details', { state: { laptop, similarProduct } });
  };
      ...
      {isLoading ? (
        ...
        <div>
          <Row className="mt-4 align-items-center">
            ...
            <Col>
              <h4 className="d-flex justify-content-center align-items-center">
                <span className="main">“</span>Rental Laptops
              ...
              <>
                ...
                <Row className="w-100 ">
                  ...
                  <Col
                    ...
                    className={`d-flex flex-row flex-wrap gaps m-0 p-0 justify-content-md-${data.length > 0 ? 'start' : 'center'} justify-content-center align-items-start align-content-start d-none  d-md-flex d-lg-flex`}
                  >
                    {isFetching ? (
                      <FetchLoader />
                    ) : (
                        ...
                        {data.length > 0 ? (
                          <>
                            {data.map((laptop, index) => (
                              <div
                                className="rounded-0 mb-2 p-2 mx-2 products-card d-flex flex-column justify-content-start align-items-start  d-none d-md-flex "
                                key={laptop._id}
                              >
                                <Col
                                        ...
                                        <Row>
                                          {chunk.map((laptop) => (
                                            <Col xs={6} key={laptop._id}>
                                              ...
                                              >
                                                <Col
                                                  className="d-flex justify-content-center align-items-center w-100 pointer products-image"
                                                  onClick={() =>
          ...
          <div className="my-5 w-100">
            <h4 className="text-center">FAQ - Rental</h4>
